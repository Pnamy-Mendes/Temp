 ...
 */
class JogadorEstatistica extends \AppBundle\Entity\JogadorEstatistica implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'Jornada', 'Entidade', 'Evento', 'Tempo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JogadorEstatistica $proxy) {
