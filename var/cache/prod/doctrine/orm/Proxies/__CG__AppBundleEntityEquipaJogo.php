 ...
 */
class EquipaJogo extends \AppBundle\Entity\EquipaJogo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'Jornada', 'Entidade', 'TempoJogado'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EquipaJogo $proxy) {
    ...
    public function setTempoJogado($tempoJogado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTempoJogado', [$tempoJogado]);

        return parent::setTempoJogado($tempoJogado);
    }
    ...
    public function getTempoJogado()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTempoJogado', []);

        return parent::getTempoJogado();
    }
