 ...
 */
class Epoca extends \AppBundle\Entity\Epoca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'ID_epoca', 'Nome', 'DataInicio', 'DataFim', 'ModosPagamento'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Epoca $proxy) {
    ...
    public function getIDEpoca()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIDEpoca', []);

        return parent::getIDEpoca();
    }
    ...
    public function addModosPagamento(\AppBundle\Entity\ModoPagamento $modosPagamento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addModosPagamento', [$modosPagamento]);

        return parent::addModosPagamento($modosPagamento);
    }
    ...
    public function removeModosPagamento(\AppBundle\Entity\ModoPagamento $modosPagamento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeModosPagamento', [$modosPagamento]);

        return parent::removeModosPagamento($modosPagamento);
    }
    ...
    public function getModosPagamento()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getModosPagamento', []);

        return parent::getModosPagamento();
    }
